  ...
  return (
    ...
    >
      <div className="w-full h-full flex flex-col p-2 bg-[#FDFDFD] shadowCard">
        <img src={dog?.avatar} alt="" className="w-full h-[70%] object-cover" />
        <div className="PetCard__content p-1 laptop:p-2 flex flex-col">
          <div className="text-14-20-700 laptop:text-16-24-700 text-[#00171F]">{dog?.name}</div>
          <div className="flex my-1 text-[#667479] flex-col laptop:flex-row">
            <div className="flex">
              <p className="text-12-18-500">Gene:</p>
              <p className="text-12-18-700 ml-[6px]">{dog?.sex == 1 ? 'Male' : 'Female'}</p>
            </div>
            ...
            <div className="flex">
              ...
              <p className="text-12-18-700 ml-[6px]">{dog?.age}</p>
            </div>
          </div>
